...
function switchMode() {
  ...
  if (Whaite === "white" && Blaick === "black") {
    ...
    document.head.innerHTML =
      "<title>Snake game v1.4 - Dark</title><style>body {margin: 0px;padding: 0px;display: flex;flex-direction: column;justify-content: center;align-items: center;background-color: black;} canvas {box-shadow: white 20px 20px 50px; border: 20px, ridge, white;} h1{color:white;} h2{color:white;} p{color:white;}</style>";
    return;
  }
  ...
  if (Whaite === "black" && Blaick === "white") {
    ...
    Blaick = "black";
    document.head.innerHTML =
      "<title>Snake game v1.4 - Light</title><style>body {margin: 0px;padding: 0px;display: flex;flex-direction: column;justify-content: center;align-items: center;background-color: white;} canvas {box-shadow: black 20px 20px 50px; border: 20px, ridge, black;} h1{color:black;} h2{color:black;} p{color:black;}</style>";
    return;
  }
}
// input
